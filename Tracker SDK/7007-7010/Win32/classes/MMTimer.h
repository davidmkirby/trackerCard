...
// We separate loop handling from the Timer class to prevent calls from 
// within OnLoop() accidentally calling CMultimediaTimer methods which could cause 
...
public:
	...
	virtual void	OnStarted(){}		// Overrideable called when timer started successfully
...
//
//	NB. OnLoop() is being called in a separate thread created by the Multimedia
